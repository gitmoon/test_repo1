...
class CommonConst:
    ...
    HEXDUMP_READ_MAC_FROM_EEPROM = "-s 250 -n 6 /sys/bus/i2c/devices/1-0050/eeprom"
    I2C_SET_DEV_2 = "dev 1"
    I2C_READ_MAC_FROM_EEPROM = "md 0x50 fa.2 6"
    ETHER_ADDR_STRING = "ether "
    ...
    COMMAND_UBOOT_MD = "md 0x50 10.2 02"
    COMMAND_UBOOT_MW = "mw 0x50 10.2 "
